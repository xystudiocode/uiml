...
- `name`: The name of the layout, which can be referenced in the code **must-fill**
...
- `name`: The name of the component, which can be referenced in the code **must-fill**
- `args`: The arguments of the component, which can be a string, list, dictionary, etc.
- `kwargs`: The keyword arguments of the component, which can be a string, list, dictionary, etc.
...
## Extend
You can redefine `widget_parser` and `layout_parser`, and then use `set_namespace` to set the namespace.